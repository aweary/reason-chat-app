...
let make ::message ::author _ => {
  ...component,
  render: fun _ => {
    <li className="chat-message">
      <img className="user-avatar" src=author.picture />
      <div className="chat-message--content">
      <div>
      <span className="chat-message--user">(ReasonReact.stringToElement author.nickname)</span>
